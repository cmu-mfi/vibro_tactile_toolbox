...
if __name__ == '__main__':
    ...
    if args.type == 'lego':
        paths = glob.glob(f'{args.data_dir}/lego_dataset/*/*/test*/MoveDownToContact/nominal/audio/*.npy')
    else:
        paths = glob.glob(f'{args.data_dir}/nist_dataset/*/{args.type}/test*/MoveDownToContact/nominal/audio/*.npy')
    if paths is not None and len(paths) > 0:
        if args.type == 'lego':
            audio_train_dataset = VibrotactileDataset(channels,f'{args.data_dir}/lego_dataset/*/*/vel*/MoveDownToContact/')
            audio_test_dataset = VibrotactileDataset(channels, f'{args.data_dir}/lego_dataset/*/*/test*/MoveDownToContact/')
        else:
            audio_train_dataset = VibrotactileDataset(channels,f'{args.data_dir}/nist_dataset/*/{args.type}/vel*/MoveDownToContact/')
            audio_test_dataset = VibrotactileDataset(channels, f'{args.data_dir}/nist_dataset/*/{args.type}/test*/MoveDownToContact/')
    else:
        if args.type == 'lego':
            audio_dataset = VibrotactileDataset(channels, f'{args.data_dir}/lego_dataset/*/{args.type}/vel*/MoveDownToContact/')
        else:
            audio_dataset = VibrotactileDataset(channels, f'{args.data_dir}/nist_dataset/*/{args.type}/vel*/MoveDownToContact/')
