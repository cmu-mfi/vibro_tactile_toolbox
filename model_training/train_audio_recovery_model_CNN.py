...
if __name__ == '__main__':
    ...
    if paths is not None:
        if args.type == 'lego':
            audio_train_dataset = VibrotactileDataset(args.type,channels,f'/mnt/hdd1/vibrotactile_data/lego_dataset/*/*/vel*/MoveDown/*/audio/*.png')
            audio_test_dataset = VibrotactileDataset(args.type,channels, f'/mnt/hdd1/vibrotactile_data/lego_dataset/*/*/test*/MoveDown/*/audio/*.png')
        else:
            audio_train_dataset = VibrotactileDataset(args.type,channels,f'/mnt/hdd1/vibrotactile_data/nist_dataset/*/{args.type}/vel*/MoveDown/*/audio/*.png')
            audio_test_dataset = VibrotactileDataset(args.type,channels, f'/mnt/hdd1/vibrotactile_data/nist_dataset/*/{args.type}/test*/MoveDown/*/audio/*.png')
    else:
        if args.type == 'lego':
            audio_dataset = VibrotactileDataset(args.type,channels, f'/mnt/hdd1/vibrotactile_data/lego_dataset/*/{args.type}/vel*/MoveDown/*/audio/*.png')
        else:
            audio_dataset = VibrotactileDataset(args.type,channels, f'/mnt/hdd1/vibrotactile_data/nist_dataset/*/{args.type}/vel*/MoveDown/*/audio/*.png')
